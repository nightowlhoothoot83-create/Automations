...
- Content, assets, finance, expenses, income, and tax are visible module seams, but their contracts need real source ownership before adapters are implemented.
- Preview links and branch-ready repair metadata require a future versioned producer contract. Automation 5 will display these when supplied; it will not invent them inside Automation 6 evidence.
