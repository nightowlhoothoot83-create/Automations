...
| Content Creator public | Restored Raven Sharp header; `CONTENT CREATOR`; centred mark; shared footer | Correct product lockup, centred mark, hero typography, spacing, suite nav and ADG footer after approved API-identity deployment. | Pass | None | API identity commit `e071085` published; visual shell unchanged. Rollback `b0e7784`. | `artifacts/automation-1/post-deploy-content-e071085/public-desktop-1280x720.png`, `public-mobile-390x844.png` | Fresh 1280 and 390 pass; no overflow, broken images, warnings or errors |
| Content Creator studio entry | Persistent Raven Sharp / Content Creator identity | Correct persistent header and product name after approved API-identity deployment. | Pass | None | API identity commit `e071085` published; visual shell unchanged. | `artifacts/automation-1/post-deploy-content-e071085/studio-desktop-1280x720.png`, `studio-mobile-390x844.png` | Fresh 1280 and 390 pass; no overflow, broken images, warnings or errors |
