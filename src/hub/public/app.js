...
function render(data) {
  ...
  if (data.mode !== 'live') { $('#mode-banner').hidden = false; $('#mode-banner').innerHTML = '<b>Demonstration mode:</b> no Automation 6 run artifact was found. Everything below is labelled sample operational data.'; }
